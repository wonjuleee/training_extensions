...
class RotatedDetectionTrainingTestParameters(DefaultOTETestCreationParametersInterface):
...
class TestRotatedDetection(OTETrainingTestInterface):
    """
    The main class of running test in this file.
    """
    PERFORMANCE_RESULTS = None # it is required for e2e system
    helper = OTETestHelper(RotatedDetectionTrainingTestParameters())
